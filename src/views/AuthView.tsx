            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent sm:text-sm transition-shadow text-black"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="appearance-none block w-full pl-10 pr-12 py-3 border border-slate-200 rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent sm:text-sm transition-shadow text-black"
                    placeholder="••••••••"
                    minLength={6}
                  />
                  <button
